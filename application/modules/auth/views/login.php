    ...
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo base_url('auth/login_action') ?>" method="post">
        <div class="input-group mb-3">
          <input type="text" autocomplete="off" name="user_mail" class="form-control" placeholder="Email or Username">
...
<script type="text/javascript">
  $(document).ready(function() {
    <?php $fail = $this->session->flashdata('fail'); ?>
    <?php if ($fail): ?>
      toastr.error("Login Gagal Periksa Kembali!");
    <?php endif ?>
  });
</script>
</body>
