		...
		<div class="card bg-white">
			<div class="card-header">
				<div class="float-left">
					<i class="fa fa-bars"></i> Manajemen Sidebar
				</div>
				<div class="float-right">
					<?php 
						$set = [
							'label'=>'Tambah Sidebar', 
							'type'=>'btn', 
							'icon'=>'fa fa-plus', 
							'id'=>'btn-add',
							'attribute'=>"data-toggle='modal' data-title='Tambah' data-url='".base_url('systems/sidebar_modal/sidebar_form')."'",
...
<script type="text/javascript">
	var table = $('table').DataTable({
		"ajax":{
			"url"       : "<?php echo base_url('systems/sidebar_table_fetch') ?>",
			"dataSrc"   : "data",
			"type"      : "POST"
		},
		"processing"    : true,
		...
		"columns"       : [
			...
			{data       : 'sidebar_icon', className : 'text-center'},
